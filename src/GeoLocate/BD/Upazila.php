...
class Upazila{
    ...
    public static function single($upazilaName)  {
        foreach(self::$upazilas as $index => $upazila){
            if($upazila['bn_name'] == $upazilaName || $upazila['name'] == $upazilaName){
                return $upazila;
            } 
        }
        return null;
